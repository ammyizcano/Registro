        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="container">
                <form action="/personas" method="POST" class="needs-validation" novalidate>
                    ...
                    <div class="mb-3" >
                        <label for="nombre" class="form-label text-secondary" for="validationTextarea" >Nombre Completo</label>
                        <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Ingrese su nombre completo" tabindex="1" required autocomplete=off>
                    ...
                    <div class="mb-3">
                        <label for="identidad" class="form-label text-secondary" for="validationTextarea" >Identidad</label>
                    ...
                    <div class="mb-3">
                        <label for="celular" class="form-label text-secondary" for="validationTextarea" >Celular</label>
                    ...
                    <div class="mb-3">
                        <label for="departamento" class="form-label text-secondary ">Departamentos</label>
                        <select name="form-label text-secondary" id="departamento" class="form-control" >
                    ...
                    <div class="mb-3">
                            <label for="formFile" class="form-label  text-secondary">Carnet de Vacunación</label>
